...
const title = {
  ...
  "product-of-the-day": "Agency of the Day",
  "product-of-the-month": "Agency of the Month",
  "product-of-the-week": "Agency of the Week",
};
...
export const AwardBadge = ({ type, place, link }: AwardBadgeProps) => {
  ...
  return (
    <a
      ...
      href={link}
      target="_blank"
      className="block size-14 cursor-pointer relative group"
      onMouseMove={onMouseMove}
      onMouseLeave={onMouseLeave}
      onMouseEnter={onMouseEnter}
      title={place ? `${title[type]} #${place}` : title[type]}
    >
      <style>
        {overlayAnimations}
      </style>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 54" className="w-full h-full">
          <defs>
            <filter id="blur1">
          ...
          <circle cx="27" cy="27" r="27" fill={backgroundColor[(place || 2) - 1] || backgroundColor[1]} />
          <circle cx="27" cy="27" r="24" fill="transparent" stroke="#bbb" strokeWidth="1" />
          ...
          <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(358, 100%, 62%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(30, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(60, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(96, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(233, 85%, 47%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(271, 85%, 47%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="hsl(300, 20%, 35%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="transparent" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
            ...
            <g style={{
              ...
              <polygon points="0,0 54,54 54,0 0,54" fill="white" filter="url(#blur1)" opacity="0.5" />
            </g>
          </g>
        </svg>
      </div>
