...
const participants: Participant[] = [
  { id: "1", name: "Oğuz", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&h=256&q=80", isSpeaking: true },
  { id: "2", name: "Ashish", avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=256&h=256&q=80" },
  { id: "3", name: "Mariana", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=256&h=256&q=80" },
  { id: "4", name: "MDS", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=256&h=256&q=80" },
  { id: "5", name: "Ana", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=256&h=256&q=80" },
  { id: "6", name: "Natko", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=256&h=256&q=80", isSpeaking: true },
  { id: "7", name: "Afshin", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=256&h=256&q=80" },
]
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          // Add scale transformation to fit within the container
      ...
      >
        ...
        >
          <div className="w-8" />
          <h2 className="text-[15px] font-sans font-semibold uppercase tracking-normal text-foreground">MEETING</h2>
          <button
            onClick={(e) => {
              e.stopPropagation()
              setIsExpanded(false)
