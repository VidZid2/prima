...
export const Calendar = ({
  ...
  const palette: CalendarPalette = isDark
    ? {
        cardBackground: "linear-gradient(180deg, #18181b 0%, #09090b 100%)",
        cardBorder: "1px solid rgba(8, 145, 178, 0.4)",
        cardShadow: "0 24px 48px -12px rgba(0, 0, 0, 0.9), inset 0 1px 1px rgba(255, 255, 255, 0.05)",
        textPrimary: "#ffffff",
        textMuted: "#a1a1aa",
        textDim: "color-mix(in srgb, #a1a1aa 68%, transparent)",
        titleColor: "#ffffff",
        navBackground: "transparent",
        navForeground: "#ffffff",
        navHoverBackground: "rgba(8, 145, 178, 0.2)",
        dayHoverBackground: "rgba(8, 145, 178, 0.2)",
        selectedGradient: "linear-gradient(180deg, #0891b2 0%, #164e63 100%)",
        selectedForeground: "#ffffff",
        todayBackground: "rgba(255, 255, 255, 0.05)",
        focusRing: "rgba(8, 145, 178, 0.4)",
        popoverBackground: "#09090b",
        popoverBorder: "1px solid rgba(8, 145, 178, 0.4)",
        popoverShadow: "0 24px 48px -12px rgba(0, 0, 0, 0.9), inset 0 1px 1px rgba(255, 255, 255, 0.05)",
        pickerHoverBackground: "rgba(8, 145, 178, 0.2)",
      }
    : {
