...
interface AnimatedGradientBackgroundProps {
   ...
   /**
    * Y position center of the radial gradient.
    * @default "20%"
    */
   centerY?: string;
}
...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
   ...
   useEffect(() => {
      ...
      const animateGradient = () => {
         ...
         const gradient = `radial-gradient(${width}% ${width+topOffset}% at 50% ${centerY}, ${gradientStopsString})`;
   ...
   }, [startingGap, Breathing, gradientColors, gradientStops, animationSpeed, breathingRange, topOffset, centerY]);
