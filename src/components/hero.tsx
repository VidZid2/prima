					...
					<div className="relative z-10 w-full flex-1 flex flex-col items-center justify-center pt-32 pb-24">
						...
						>
							...
							<div className="relative">
								...
								<h1 className="text-center font-sans font-medium text-[9vw] sm:text-5xl md:text-7xl lg:text-[80px] leading-[1.1] md:leading-[1.05] tracking-tight bg-gradient-to-b from-white via-zinc-100 to-zinc-400 bg-clip-text text-transparent drop-shadow-[0_4px_16px_rgba(0,0,0,0.6)] mb-6 max-w-6xl">
